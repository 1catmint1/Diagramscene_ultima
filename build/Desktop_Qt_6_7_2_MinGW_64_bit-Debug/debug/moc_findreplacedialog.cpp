...
constexpr auto qt_meta_stringdata_CLASSFindReplaceDialogENDCLASS = QtMocHelpers::stringData(
    "FindReplaceDialog",
    "findText",
    "",
    "text",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFindReplaceDialogENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       6,    0,   63,    2, 0x08,    9 /* Private */,
       7,    0,   64,    2, 0x08,   10 /* Private */,
       8,    0,   65,    2, 0x08,   11 /* Private */,

 // signals: parameters
    QMetaType::Void, QMetaType::QString,    3,
    QMetaType::Void, QMetaType::QString, QMetaType::QString,    1,    4,
    QMetaType::Void, QMetaType::QString, QMetaType::QString,    1,    4,
...
void FindReplaceDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FindReplaceDialog::*)(const QString & );
            if (_t _q_method = &FindReplaceDialog::findText; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &FindReplaceDialog::replaceText; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (FindReplaceDialog::*)(const QString & , const QString & );
            if (_t _q_method = &FindReplaceDialog::replaceAllText; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
