...
Q_CONSTINIT static const uint qt_meta_data_CLASSDiagramSceneENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      ...
      15,    1,   77,    2, 0x0a,   11 /* Public */,
      17,    1,   80,    2, 0x0a,   13 /* Public */,
      18,    0,   83,    2, 0x0a,   15 /* Public */,
...
void DiagramScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: { QGraphicsItem* _r = _t->createItem((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])));
            if (_a[0]) *reinterpret_cast< QGraphicsItem**>(_a[0]) = std::move(_r); }  break;
        case 7: { QGraphicsTextItem* _r = _t->createTextItem();
