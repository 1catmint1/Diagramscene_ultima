...
Q_CONSTINIT static const uint qt_meta_data_CLASSDiagramSceneENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      12,    1,   80,    2, 0x0a,    9 /* Public */,
      15,    1,   83,    2, 0x0a,   11 /* Public */,
      18,    1,   86,    2, 0x0a,   13 /* Public */,
      20,    1,   89,    2, 0x0a,   15 /* Public */,
      21,    0,   92,    2, 0x0a,   17 /* Public */,
...
Q_CONSTINIT const QMetaObject DiagramScene::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDiagramSceneENDCLASS_t,
        ...
        // method 'pathInserted'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<DiagramPath *, std::false_type>,
        // method 'setMode'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void DiagramScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DiagramScene::*)(DiagramPath * );
            if (_t _q_method = &DiagramScene::pathInserted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
