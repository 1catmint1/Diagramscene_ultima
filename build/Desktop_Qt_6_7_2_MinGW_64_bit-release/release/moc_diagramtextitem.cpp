...
struct qt_meta_stringdata_CLASSDiagramTextItemENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSDiagramTextItemENDCLASS = QtMocHelpers::stringData(
    "DiagramTextItem",
    "lostFocus",
    "",
    "DiagramTextItem*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSDiagramTextItemENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject DiagramTextItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSDiagramTextItemENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSDiagramTextItemENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSDiagramTextItemENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DiagramTextItem, std::true_type>,
        // method 'lostFocus'
...
void *DiagramTextItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSDiagramTextItemENDCLASS.stringdata0))
